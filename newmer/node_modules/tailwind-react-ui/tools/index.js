...
var TailwindThemeProvider = function TailwindThemeProvider(_ref) {
  ...
  return React__default.createElement(TailwindTheme.Provider, {
    value: mergedTheme
  }, children);
};
...
var withTheme = function withTheme(Component) {
  var WithTheme = function WithTheme(props) {
    return React__default.createElement(TailwindTheme.Consumer, null, function (theme) {
...
var withTheme$1 = function withTheme(Component, _ref) {
  ...
  var WithTransition = function WithTransition(componentProps) {
    return React__default.createElement(reactTransitionGroup.Transition, _extends({
      in: get(componentProps, inState),
      timeout: 0
    }, rest), function (state) {
      return React__default.createElement(Component, _extends({}, componentProps, {
        transition: state
      }));
    });
  };
...
var withTailwind = function withTailwind(Component, _temp) {
  ...
  var WithTailwind = function WithTailwind(_ref2) {
    ...
    return React__default.createElement(Component, _extends({}, filterProps(props, tailwindProps.filter(function (prop) {
...
var Base = function Base(_ref) {
  ...
  var Component = is;
  return React__default.createElement(Component, _extends({}, filterProps(rest, tailwindProps), {
...
var Box = function Box(_ref) {
  ...
  return React__default.createElement(Base$1, _extends({
    is: el,
    inline: inline,
...
var Image = function Image(_ref) {
  ...
  }), React__default.createElement(Base$1, _extends({
    is: is,
    absolute: true,
    pin: true,
    w: "full"
...
var Subtitle = function Subtitle(props) {
  return React__default.createElement(Title$1, _extends({}, props, {
    subtitle: true
  }));
};
...
var BrandText = function BrandText(_ref) {
  ...
  return React__default.createElement(Paragraph$1, _extends({}, rest, {
    brand: true,
    rounded: theme.radius,
...
var DangerText = function DangerText(props) {
  return React__default.createElement(BrandText$1, _extends({}, props, {
    type: "danger"
  }));
};
...
var ContentTitle = function ContentTitle(_ref) {
  ...
  return React__default.createElement(Title$1, _extends({
    id: id,
...
var Article = function Article(_ref) {
  ...
  return React__default.createElement(ContentBlock$1, _extends({
    is: is
  }, rest));
};
...
var Footer = function Footer(_ref) {
  ...
  }, rest), React__default.createElement(Container$1, {
    padding: true
  }, children));
};
...
function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return React__default.createElement(Box, _extends({
      ...
      maxW: "sm"
    }, filterProps(rest, ['id'])), React__default.Children.map(children, function (child) {
      return React__default.cloneElement(child, {
        field: fieldProps
      });
    }));
...
var Select = function Select(_ref) {
  ...
  }, rest), !!placeholder && React__default.createElement("option", {
    value: ""
...
function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    }, checked && (checkbox ? React__default.createElement(Box, {
      is: "svg",
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 24 24",
      h: 3,
...
var Radio = function Radio(props) {
  return React__default.createElement(OptionInput$1, _extends({}, props, {
    checkbox: false
  }));
};
...
var List = function List(_ref) {
  ...
  return React__default.createElement(Box, _extends({
    ...
    return child && React__default.createElement(Box, {
      is: listItemIs,
      m: {
...
var Row = function Row(_ref) {
  ...
  return React__default.createElement(Flex, _extends({
    ...
    listReset: true
  }, rest), gutter ? React__default.Children.map(children, function (child) {
    return React__default.cloneElement(child, {
      p: {
        l: gutterSpacing
      },
...
function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return React__default.createElement(Box, _extends({
      ...
      role: "banner"
    }, filterProps(rest, ['id'])), React__default.createElement(Container$1, {
      is: Flex,
      wrap: true,
      items: "center",
      justify: "between",
...
var NavMenu = function NavMenu(_ref) {
  ...
  return React__default.createElement(Box, _extends({
    ...
    role: "navigation"
  }, responsive.nav, rest), React__default.createElement(Title$1, {
    level: 2,
    id: headingId,
    visuallyHidden: true
  }, "Site menu"), React__default.createElement(List$1, _extends({
    reset: true,
    flex: "grow",
    role: "menu",
    listItemIs: NavItemWrapper
  }, responsive.menu, list), React__default.Children.map(children, function (child) {
    return child.type === NavItem$1 && React__default.cloneElement(child, {
      header: header,
      role: 'menuitem'
    });
  })), React__default.Children.map(children, function (child) {
...
var NavToggle = function NavToggle(_ref) {
  ...
  }, responsive, rest), children || React__default.createElement(Box, {
    flex: [true, 'col'],
    items: "stretch",
    justify: "around",
    h: "full",
    p: 3
  }, React__default.createElement(Bar, null), React__default.createElement(Bar, null), React__default.createElement(Bar, null)));
};
...
var SkipLink = function SkipLink(_ref) {
  ...
  }, React__default.createElement(FillButton, _extends({
    is: "a",
    bg: "white",
    text: "black",
    absolute: true,
...
var lib = /*#__PURE__*/Object.freeze({
  ...
  getTailwindClassNames: getTailwindClassNames,
  tailwindProps: tailwindProps,
  propTypes: propTypes,
  propVariants: propVariants,
  tailwindPropToClassName: tailwindPropToClassName,
  withTailwind: withTailwind,
  defaultTheme: defaultTheme,
  TailwindTheme: TailwindTheme,
  TailwindThemeProvider: TailwindThemeProvider,
  withTheme: withTheme,
  useThemeValue: useThemeValue,
  getAsArray: getAsArray,
  filterProps: filterProps,
  getUniqueID: getUniqueID,
  withTransition: withTheme$1
});

var renderComponentsToString = (function (projectTheme) {
  if (projectTheme === void 0) {
    projectTheme = {};
  }

  var TailwindThemeProvider$$1 = TailwindThemeProvider;
  return ReactDOMServer.renderToStaticMarkup(React__default.createElement(TailwindThemeProvider$$1, {
    theme: projectTheme
  }, Object.keys(lib).map(function (key) {
...
var mapObject = function mapObject(obj, prefix) {
  return Object.keys(obj).map(function (key) {
    return prefix + "-" + obj[key];
  });
};

var mapArray = function mapArray(arr, prefix) {
  return arr.map(function (value) {
    return prefix + "-" + value;
  });
};

var reduceMultiple = function reduceMultiple(obj, prefixes, suffixes) {
  return Object.keys(obj).reduce(function (arr, key) {
    if (typeof obj[key] === 'object') {
      return arr.concat(reduceMultiple(obj[key], prefixes));
    }

    if (suffixes) {
      var baseClass = obj[key].indexOf('-') !== -1 ? obj[key].split('-')[0] : obj[key];
      return arr.concat(prefixes.reduce(function (classes, prefix) {
        return classes.concat(suffixes.map(function (suffix) {
          return suffix !== '' ? "-" + suffix : '';
        }).map(function (suffix) {
          return prefix + "-" + baseClass + suffix;
        }));
      }, []));
    }

    return arr.concat(prefixes.map(function (prefix) {
      return prefix + "-" + obj[key];
    }));
  }, []);
};

var colorPrefixes = ['bg', 'border', 'text', 'hover:bg', 'hover:border', 'hover:text', 'focus:bg', 'focus:border', 'focus:text'];
var colorSuffixes = ['darkest', 'darker', 'dark', '', 'light', 'lighter', 'lightest'];
var getThemeWhitelist = (function (projectTheme) {
  if (projectTheme === void 0) {
    projectTheme = {};
  }

  var theme = merge(defaultTheme, projectTheme);
  return [theme.radius].concat(reduceMultiple(theme.spacing, ['mt', 'mb', 'mr', '-ml', '-mr', 'p-', 'pl-', 'px-', 'py-']), mapObject(theme.container, 'max-w'), mapArray(theme.text.size.body, 'text'), mapArray(theme.text.size.title, 'text'), mapObject(theme.text.family, 'font'), reduceMultiple(theme.brandColors, colorPrefixes, colorSuffixes), reduceMultiple(theme.textColors, colorPrefixes)).filter(function (className, index, self) {
    return self.indexOf(className) === index;
  });
});

/* eslint-disable no-useless-escape */
var classRegex = /[A-Za-z0-9-_:\/]+/g; // TODO: Array values

var propRegex = {
  singleValue: function singleValue(prop) {
    return new RegExp("[ \n\r\t]" + prop + "(?:-[A-Za-z]+)?=[\"'{}][A-Za-z0-9-_:/]+[\"'}]", 'g');
  },
  booleanValue: function booleanValue(prop) {
    return new RegExp("[ \n\r\t]" + prop + "(?:-[A-Za-z]+)?(?:[ \n\r]|>)", 'g');
  },
  objectValue: function objectValue(prop) {
    return new RegExp("[ \n\r\t]" + prop + "(?:-[A-Za-z]+)?={{ ?[A-Za-z0-9-_:/ '\",]+ ?}}", 'g');
  }
};
var transformations = {
...
var TailwindReactExtractor =
/*#__PURE__*/
function () {
  function TailwindReactExtractor() {}

  TailwindReactExtractor.extract = function extract(content) {
    var classNames = [];
    tailwindProps.forEach(function (prop) {
      var matches = (content.match(propRegex.singleValue(prop)) || []).concat(content.match(propRegex.booleanValue(prop)) || []);
      var objMatches = content.match(propRegex.objectValue(prop)) || [];

      if (objMatches.length) {
        objMatches = objMatches.reduce(function (array, match) {
          return array.concat(match.replace(/\s/g, '').replace(prop + "=", '').replace(/[{}'"]/g, '').split(',').map(function (objProp) {
            var classFragments = objProp.split(':');
            var key = classFragments[0];
            return key.length === 1 ? "" + prop + key + "-" + classFragments[1] : "" + prop + (key === 'def' ? '' : "-" + classFragments[0]) + "-" + classFragments[1];
          }));
        }, []);
        matches = matches.concat(objMatches);
      }

      classNames = classNames.concat(matches.map(function (match) {
        return match.replace(/[\s"'{}>]/g, '').replace('=', '-').replace(/[A-Z]/g, '-$&').toLowerCase();
      }).reduce(function (classes, match) {
        var className = [match];
        propVariants.forEach(function (variant) {
          if (match.includes(variant)) {
            className = match.replace("-" + variant, '');
            className = variant === 'hocus' ? ["hover:" + className, "focus:" + className] : [variant + ":" + className];
          }
        });

        if ((prop === 'bg' || prop === 'text') && className[0].indexOf(':') === -1) {
          // TODO: Determine if prop value is a colour
          var baseColor = className[0].replace(prop + "-", '');
          var highlightColor = getColorShade(baseColor);
          className = [match, "hover:" + prop + "-" + baseColor, "focus:" + prop + "-" + baseColor, "hover:" + prop + "-" + highlightColor, "focus:" + prop + "-" + highlightColor];

          if (prop === 'bg') {
            className.push("hover:" + prop + "-" + getColorShade(baseColor, 'lightest'), "focus:" + prop + "-" + getColorShade(baseColor, 'lightest'));
          }
        }
        ...
        if (className.indexOf(':') !== -1) {
          ...
          return transformations[classFragments[1]] ? classFragments[0] + ":" + transformations[classFragments[1]] : className;
        }

        return transformations[className] || className;
      });
    });
    return classNames.concat(content.match(classRegex) || []).filter(function (className, index, array) {
      return array.indexOf(className) === index;
    });
  };

  return TailwindReactExtractor;
}();

var getWhitelist = (function (projectTheme, projectWhitelist) {
  if (projectTheme === void 0) {
    projectTheme = {};
  }

  if (projectWhitelist === void 0) {
    projectWhitelist = [];
  }

  var components = renderComponentsToString(projectTheme); // eslint-disable-next-line no-useless-escape

  var componentWhitelist = components.match(classRegex) || [];
  return componentWhitelist.concat(getThemeWhitelist(projectTheme), projectWhitelist).filter(function (className, index, array) {
    return array.indexOf(className) === index;
  });
});

exports.renderComponentsToString = renderComponentsToString;
exports.getThemeWhitelist = getThemeWhitelist;
exports.getWhitelist = getWhitelist;
exports.TailwindReactExtractor = TailwindReactExtractor;
